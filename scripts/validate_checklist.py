"""Quick validation checklist runner for Phase 6."""
import json
import numpy as np
import pandas as pd
...
t = pd.read_csv("data/processed/indianized_transactions.csv")
...
f = pd.read_csv("data/processed/feature_matrix.csv")
...
# [3] Model AUCs
m = json.loads(open("data/models/model_metadata.json").read())
...
hl = pd.read_csv("data/processed/health_labels.csv")
...
gi = json.loads(open("data/models/shap_global_importance.json").read())
